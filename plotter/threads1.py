...
class GUI(QWidget):
    ...
    def __init__(self, parent=None, **kwargs):
        ...
        self.obj=Threaded(result=self.displayPrime)
        
        self.requestPrime.connect(self.obj.calculatePrime)
        self._thread.started.connect(self.obj.start)
        self.obj.moveToThread(self._thread)
        ...
        self._requestBtn=QPushButton( "Calculate Prime", self, clicked=self.primeRequested)
